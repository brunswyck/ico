...
[ERC20 functions](https://docs.openzeppelin.com/contracts/2.x/api/token/erc20)
...
[openzeppelin's ERC20 contract](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC20/ERC20.sol)
...
# Save the CryptoDevToken Contract Address that was printed
```
...
# deploy app
go to vercel and deploy my-app project
